                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form:form class="cmxform form-horizontal tasi-form" id="signupForm" method="POST"
                                       action="/admin/updateProductPost">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <form:input class=" form-control" id="firstname" type="text" required="required"
                                                    value="${productDetail.description}" path="description"/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="password" class="control-label col-lg-2">Price</label>
                                    <div class="col-lg-6">
                                        <form:input class="form-control" id="password" type="text"
                                                    value="${productDetail.productDetailPrice}" required="required"
                                                    path="productDetailPrice"/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="lastname" class="control-label col-lg-2">Quantity</label>
                                    <div class="col-lg-6">
                                        <form:input class=" form-control" id="quantityProduct" name="quantityProduct"
                                                    type="text" value="${productDetail.productDetailQuantity}"
                                                    required="required" path="productDetailQuantity"/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <form:input class=" form-control" id="email" type="text" required="required"
                                                    value="${productDetail.supplyer}" path="supplyer"/>
                                    </div>
                                </div>
                                <div class="form-group">
