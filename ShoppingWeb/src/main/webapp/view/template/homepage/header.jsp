			...
			<div class="col-sm-6">
				<div class="header_top_left">
					<ul class="nav nav-pills">
						<li>
							<img class="banner-img" src="resource/images/banner/auction.png">
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="header_top_right">
					<ul class="nav nav-pills">
						<c:if test="${pageContext.request.userPrincipal.name !=null }">
							<li class="personal-setting"><a class="personal-profile">Chào
									${pageContext.request.userPrincipal.name}</a></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown"> <b class="caret"></b></a>
								<ul class="dropdown-menu item-settings">
								<security:authorize access="isAuthenticated()">
									<li class="${current=='profile' ? 'active' : ''} personal-setting"><a class="personal-profile"
										href="${pageContext.request.contextPath }/profile">Trang cá nhân</a>
									</li>
								</security:authorize>
