            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
              ...
              <c:forEach var="productDetail" items="${listProductDetails}">
                ...
                <tr class="gradeX">
                  ...
                  <td><img src="${contextPath}/resource/images/${productDetail.getProductImages().get(0).getUrl()}" style="width:50px;height:50px"></td>
                  ...
                  <td class="center hidden-phone"><a href='<c:url value="/admin/updateProduct"><c:param name="productDetailId" value="${productDetail.id}"/></c:url>'><button class="btn btn-success">Update Product</button></a></td>
                </tr>
              </c:forEach>
              </tbody>
            </table>
