                    ...
                    <div class="row  wow fadeInUp">
                            ...
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                ...
                                <div id="owl-single-product">
                                    <div class="single-product-gallery-item" id="slide1">
                                        <a data-lightbox="image-1" data-title="Gallery" href="${contextPath}/resource/images/${productDetail.productImages.get(0).url}">
                                            <img class="img-responsive" alt="" src="${contextPath}/resource/images/${productDetail.productImages.get(0).url}" data-echo="${contextPath}/resource/images/${productDetail.productImages.get(0).url}" />
                                        </a>
                                        ...
                                        <c:forEach var="productImages" items="${productDetail.productImages}">
                                            <div class="item">
                                                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide2">
                                                    <img class="img-responsive" width="85" alt="" src="${contextPath}/images/${productImages.url}" data-echo="${contextPath}/images/${productImages.url}"/>
                                                </a>
                                            </div>
                                        </c:forEach>
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                <h1 class="name">${productDetail.product.productName}</h1>
                                ...
                                <div class="price-container info-container m-t-20">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                <span class="price">$ ${productDetail.productDetailPrice}</span>
                                                <span class="price-strike">$ 0</span>
                                            </div>
                                        </div>
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href='<c:url value="detail.html"><c:param name="productDetailId" value="${productDetail.id}"/>></c:url>'><img  src="${contextPath}/resource/images/${productDetail.productImages.get(0).url}" alt=""></a>
                                            </div><!-- /.image -->
