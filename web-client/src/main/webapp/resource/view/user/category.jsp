    ...
    <div class='row'>
      ...
      <div class='col-md-9'>
        ...
        <div id="category" class="category-carousel hidden-xs">
          <div class="item">
            <div class="image">
              <img src="${contextPath}/resource/view/template/assets/images/banners/cat-banner-1.jpg" alt="" class="img-responsive">
            </div>
                    ...
                    <div class="products">
                      ...
                      <div class="product">
                        <div class="product-image">
                          <div class="image">
                            <a href='<c:url value="detail.html"><c:param name="productDetailId" value="${list8ProductDetail[i].id}"/></c:url>'><img
      ...
      <div class="logo-slider-inner">
        <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
          <div class="item m-t-15">
            <a href="#" class="image">
              <img data-echo="assets/images/brands/brand1.png" src="${contextPath}/resource/view/template/assets/images/blank.gif" alt="">
            </a>
          </div><!--/.item-->

          <div class="item m-t-10">
            <a href="#" class="image">
              <img data-echo="assets/images/brands/brand2.png" src="${contextPath}/resource/view/template/assets/images/blank.gif" alt="">
            </a>
          </div><!--/.item-->

          <div class="item">
            <a href="#" class="image">
              <img data-echo="assets/images/brands/brand3.png" src="${contextPath}/resource/view/template/assets/images/blank.gif" alt="">
            </a>
          </div><!--/.item-->

          <div class="item">
            <a href="#" class="image">
              <img data-echo="assets/images/brands/brand4.png" src="${contextPath}/resource/view/template/assets/images/blank.gif" alt="">
            </a>
          </div><!--/.item-->

          <div class="item">
            <a href="#" class="image">
              <img data-echo="assets/images/brands/brand5.png" src="${contextPath}/resource/view/template/assets/images/blank.gif" alt="">
            </a>
          </div><!--/.item-->

          <div class="item">
            <a href="#" class="image">
              <img data-echo="assets/images/brands/brand6.png" src="${contextPath}/resource/view/template/assets/images/blank.gif" alt="">
            </a>
          </div><!--/.item-->
